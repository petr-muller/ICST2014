...
inter-process communication in the GNU/Linux ecosystem. Programs receiving data over
...
including \textit{GNOME Shell} and \textit{systemd}. The bugs usually result in crashes, but we
have found other bugs like memory leaks and even a data-loss bug.
...
actually an internal API. The discussion is interesting by showing that
D-Bus usage is not a fully mature area of engineering, and programmers do
