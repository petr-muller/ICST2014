...
message is often neglected, and in some cases even thought as unecessary. One of
...
message bus infrastructure. Section \ref{sec:C} descibes \textsc{Dfuzzer} and compares
...
It mostly seems that \textsc{dbusfuzz.py} is designed to be used programatically
...
purpose of Dfuzzer. In full testing of whole D-Bus eco-system in a operating system
distribution, \textsc{Dfuzzer} and BendyBus might complement each other nicely.
