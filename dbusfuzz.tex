...
\title{Le Grande D-Bus Fuzzin'}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Mat\'{u}\v{s} Marfefka and Petr Muller and \addtodo{jeste nekdo? Milos?}}
\IEEEauthorblockA{Faculty of Information Technology\addtodo{Spravit affiliations}\\
