...
times (from IMSettings daemon initial memory which was 748 kB to 107 MB).
...
Even in this limited campaign, we found 31 bugs in 16 packages from total 32
packages which provide services on D-Bus daemons.
