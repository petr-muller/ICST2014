...
of~testing\cite{Fuzzing2}: it it an automated, brute force, black-box
...
long history of being applied in security area\cite{Fuzzing}, because
...
16 bugs and approximately half of them were more serious issues.\addtodo{More
details, maybe a table with bug classifications and origin} The most critical
bug found was the removal of root account which occured when we were fuzzing service provided by \emph{accountsservice} package. Other serious bugs
